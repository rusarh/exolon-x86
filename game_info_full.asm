...
show2BottomLine:
mov dx, offset xMSG_bottomText	;		ld	hl, xMSG_bottomText
call	xMSG;		call	xMSG
;
call	osd_AMMO;		call	osd_AMMO
call	osd_GRENADES;	call	osd_GRENADES
call	osd_LIVES;		call	osd_LIVES
jmp 	osd_ZONE;		jp	osd_ZONE
